...
export const TRACKER_DONE_LOADING = 'TRACKER_DONE_LOADING'
export const TRACKER_SUCCESS = 'TRACKER_SUCCESS'
export const TRACKER_SEMESTER_SELECTED = 'TRACKER_SEMESTER_SELECTED'
export const TRACKER_CLASS_SELECTED = 'TRACKER_CLASS_SELECTED'